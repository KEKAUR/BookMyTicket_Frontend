...
const TheatreUpdateModal = ({ onClose, getTheatre, setLoading, theatreId, theatreData }) => {
        ...
        <ModalOverlay onClick={onClose}>
            <ModalContent onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <SubmitButton type="submit">Update Theatre</SubmitButton>
...
export default TheatreUpdateModal;
